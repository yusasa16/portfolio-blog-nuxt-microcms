...
<template>
  <div class="relative flex items-top justify-center min-h-screen bg-gray-100 sm_items-center sm_pt-0">
    <!-- <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.1.2/dist/tailwind.min.css" rel="stylesheet"> -->
    <div class="max-w-4xl mx-auto sm_px-6 lg_px-8">
      <a class="flex justify-center pt-8 sm_pt-0" href="https://nuxtjs.org" target="_blank">
      ...
      <div class="mt-8 bg-white overflow-hidden shadow sm_rounded-lg p-6">
        <h2 class="text-2xl leading-7 font-semibold">
          Welcome to your Nuxt Application
        </h2>
        <p class="mt-3 text-gray-600">
          We recommend you take a look at the <a href="https://nuxtjs.org" target="_blank" class="text-green-500 hover_underline">Nuxt documentation</a>, whether you are new or have previous experience with the framework.<br>
        </p>
      ...
      <div class="flex justify-center pt-4 space-x-2">
        <a href="https://github.com/nuxt/nuxt.js" target="_blank"><svg
          class="w-6 h-6 text-gray-600 hover_text-gray-800"
